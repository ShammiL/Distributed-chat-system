...
public class RequestDeserializerTest extends TestCase {
    ...
    public void testNewIdentifier() {
        NewIdentityRequest request = gson.fromJson(NEW_IDENTITY_JSON, NewIdentityRequest.class);
    ...
    public void testList() {
        ListRequest request = gson.fromJson(LIST_JSON, ListRequest.class);
        assertEquals(RequestConstants.LIST, request.getType());
    }

    @Test
    public void testWho() {
        WhoRequest request = gson.fromJson(WHO_JSON, WhoRequest.class);
        assertEquals(RequestConstants.WHO, request.getType());
    }

    public void testCreateRoom() {
        CreateRoomRequest request = (CreateRoomRequest) gson.fromJson(CREATE_ROOM_JSON, AbstractRequest.class);
    ...
    public void testJoinRoom() {
        JoinRoomRequest request = (JoinRoomRequest) gson.fromJson(JOIN_ROOM_JSON, AbstractRequest.class);
    ...
    public void testMoveJoin() {
        MoveJoinRequest request = (MoveJoinRequest) gson.fromJson(MOVE_JOIN_JSON, AbstractRequest.class);
    ...
    public void testDeleteRoom() {
        DeleteRoomRequest request = (DeleteRoomRequest) gson.fromJson(DELETE_ROOM_JSON, AbstractRequest.class);
    ...
    public void testMessage() {
        MessageRequest request = gson.fromJson(MESSAGE_JSON, MessageRequest.class);
    ...
    public void testQuit() {
        QuitRequest request = gson.fromJson(QUIT_JSON, QuitRequest.class);
